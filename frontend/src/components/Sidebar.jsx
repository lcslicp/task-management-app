        ...
        <ul className='space-y-2'>
          ...
          <li className='flex items-center space-x-4 pb-6' id='user-info'>
            ...
            <div className='space-y-1'>
              ...
              <div class='text-xs text-white'>hardcoded@email.com</div>
            </div>
          </li>
          <li>
            <a
              href='#'
              className='flex items-center p-2 text-base font-normal text-white rounded-full hover:bg-darkerblue'
            >
              <svg
          ...
          <li>
            ...
            >
              <svg
                class='flex-shrink-0 w-6 h-6 text-white transition duration-75'
                fill='currentColor'
                viewBox='0 0 20 20'
                xmlns='http://www.w3.org/2000/svg'
              >
            ...
            <ul id='sort-dropdown' class='hidden py-2 space-y-2'>
              <li>
                <a
                  href='#'
                  className='flex items-center p-2 text-base font-normal text-white rounded-full hover:bg-darkerblue'
          ...
          <li>
            <a
              href='#'
              className='flex items-center self-end p-2 text-base font-normal text-white rounded-full hover:bg-darkerblue'
            >
              <svg
