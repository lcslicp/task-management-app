      ...
      <div id='main-links'>
        ...
        <ul className='space-y-2 flex flex-col mt-16'>
          <li className='flex flex-row justify-between'>
            ...
            >
              <svg className={`w-3 h-3 opacity-50 ${dashboardSelected ? 'fill-black' : 'fill-white'}`} viewBox='0 0 14 14' fill='none' xmlns="http://www.w3.org/2000/svg">
          ...
          <li className='w-full'>
            ...
            >
              <svg className={`w-3 h-3 opacity-50  ${sort !== 'newest' ? 'fill-black' : sort === 'newest' && toggleSort ? 'fill-white' : 'fill-white'}`} viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li className='w-full'>
            ...
            >
              <svg className={`w-3 h-3 opacity-50 ${priorityFilter.length === 0 ? 'fill-white' :  'fill-black'}`} viewBox='0 0 16 14' fill='none' xmlns='http://www.w3.org/2000/svg'>
