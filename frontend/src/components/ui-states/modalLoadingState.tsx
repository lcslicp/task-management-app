...
const ModalLoading = () => {
  ...
  return (
    <div
      id="loadingstate-modal"
      className="flex flex-col p-12 w-full max-w-2xl max-h-full  justify-center items-center h-96"
    >
      ...
      <div
        className="w-32 h-32 px-3 m-auto
        "
      >
        <svg
          aria-hidden="true"
          className="w-15 h-15 text-offwhite animate-spin  fill-black"
          viewBox="0 0 100 101"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
