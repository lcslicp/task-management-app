...
const TaskCard = ({
  ...
  return (
    <div className='p-6 max-w-sm pl-8 bg-white rounded-lg border border-lightergray shadow-md hover:grey h-fit mb-8 break-inside-avoid cursor-pointer break-words'>
      ...
      <div className='flex flex-col -mt-14' onClick={() => handleTaskOpen(id)}>
        <h1 className='text-base font-semibold tracking-tight text-darkblue pb-2 break-words'>
          {title}
        </h1>
        <p
          className={(() => {
